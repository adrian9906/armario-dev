...
describe("Supabase configuration", () => {
  it("keeps the app in setup mode without credentials", () => {
  ...
  it("accepts a configured project", () => {
    ...
    expect(getSupabaseConfig()).toEqual({ url: "https://example.supabase.co", publishableKey: "sb_publishable_example" });
  });
});
