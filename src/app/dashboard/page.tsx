  ...
  return <SidebarProvider>
    ...
    <SidebarInset className="min-h-screen bg-background">
      ...
      <main className="mx-auto w-full max-w-6xl px-5 py-9 sm:px-8">
        ...
        {dataError && <Alert variant="destructive" className="mb-7"><AlertTitle>No se pudieron cargar los datos</AlertTitle><AlertDescription>Actualiza la página. Si el problema continúa, revisa la conexión con Supabase.</AlertDescription></Alert>}
